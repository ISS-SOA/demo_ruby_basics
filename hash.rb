...
learned_ruby.keys                # => ["soumya", "lee", "james", "angelina"]
...
learned_ruby.select { |_key, value| value == 2015 }
# => {"james"=>2015, "angelina"=>2015}

learned_ruby.key?('soumya')                  # => true
learned_ruby.key?('ray')                     # => false
...
learned_ruby.select { |_, year| year == Time.now.year - 1 }
# => {"james"=>2015, "angelina"=>2015}
# => It's now 2016
